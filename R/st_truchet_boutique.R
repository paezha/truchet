st_truchet_boutique <- function(x = 0, y = 0, type = "ribbon_1"){
  ...
  #' @note For a discussion of variable tiling patterns see: Robert J.Krawczyk (2020) Infinitely Variable Tiling Patterns: From Truchet to Sol LeWitt Revisited, Patterns, 1:5, 1-4, \url{https://www.cell.com/patterns/fulltext/S2666-3899(20)30112-4} and
  #' Robert J.Krawczyk (2011) Truchet tilings revisited, Proceedings of ISAMA 2011, 69-77 \url{https://silo.tips/download/truchet-tilings-revisited}
