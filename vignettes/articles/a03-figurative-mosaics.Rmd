...
This article shows how to use {truchet} to generate figurative mosaics. In addition to {truchet}, we need [{dplyer}](https://dplyr.tidyverse.org/index.htm), [{ggplot2}](https://ggplot2.tidyverse.org/), and [{imager}](https://dahtah.github.io/imager/imager.html), [{purrr}](https://purrr.tidyverse.org/), and [{sf}](https://r-spatial.github.io/sf/):
