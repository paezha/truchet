...
```{r}
set.seed(7352)
mosaic <- st_truchet_ms(tiles = c("dr", "tn"), p1 = 1)
```
...
Techincally, the function summarizes the geometry objects by color, and then performs a union to dissolve the boundaries. See:
```{r}
ggplot() +
